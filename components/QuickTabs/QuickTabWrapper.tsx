  ...
  return (
    ...
    >
      ...
      <button
        title="Close"
        className={classNames(
          "h-quick-start w-quick-start bg-dark-gray rounded-full absolute transition-all duration-300 ease-in-out",
      ...
      <button
        className={classNames(
          "rounded-full bg-white flex justify-center items-center transition-all duration-300 ease-in-out h-quick-start w-quick-start",
